...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference("Concert.count") do
      post concerts_url, params: { concert: { artist_id: @concert.artist_id, city: @concert.city, date: @concert.date, name: @concert.name, state: @concert.state, venue: @concert.venue } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { artist_id: @concert.artist_id, city: @concert.city, date: @concert.date, name: @concert.name, state: @concert.state, venue: @concert.venue } }
